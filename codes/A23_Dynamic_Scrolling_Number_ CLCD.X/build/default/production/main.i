...
uint8_t KeyPad_GetKeychar(uint8_t num);
# 4 "main.c" 2
...
uint8_t Preset_Non_Preset_Mode = 0;




uint8_t Start_Stop_Mode = 3;
    ...
    while (1) {
        ...
        switch (KeyPad_Pressed_Key) {
            case '1':
                ...
                if (Start_Stop_Mode == 2) {
                    Shift = 0;
                }
                if (Preset_Non_Preset_Mode == 0) {
