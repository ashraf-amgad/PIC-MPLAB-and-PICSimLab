...
# 6 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\include\\c90\\string.h" 2 3

# 1 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\__null.h" 1 3
# 7 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\include\\c90\\string.h" 2 3
...
# 41 "main.c"
char Massage[20] = "1 2 3 4 5 6 7 8     ";
int8_t Massage_Offset = 0;



uint8_t Massage_Start_Stop = 1;



uint8_t Massage_Direction = 1;
...
# 117 "main.c"
        ...
        if (RB5 == 0) {
            switch (Massage_Start_Stop) {
                case 1:
                    Massage_Start_Stop = 2;
                    break;

                case 2:
                    Massage_Start_Stop = 1;
                    break;
            }
            while (RB5 == 0);
        }
        ...
        if (Timer_Flag == 1) {
            ...
            if (Massage_Start_Stop == 1) {

                if (Massage_Direction == 1) {
                    Massage_Offset += 4;
                } else if (Massage_Direction == 2) {
                    Massage_Offset -= 4;
                }
