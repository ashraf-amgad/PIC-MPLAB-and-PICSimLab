...
uint8_t SSD1_counter = 0;
uint8_t SSD2_counter = 0;
uint8_t SSD3_counter = 0;
uint8_t SSD4_counter = 0;
...
uint8_t Set_Edit_status = 0;



uint8_t LED_BLINK_STATUS = 1;
# 55 "main.c"
uint8_t Select_Field_status = 1;


int8_t Seconds_PreRest_Value = 0;
int8_t Minute_PreRest_Value = 0;
    ...
    while (1) {
        ...
        if (RB3 == 0) {
            ...
            switch (Set_Edit_status) {
                ...
                case (0):
                    Seconds_PreRest_Value = Seconds_Counter;
                    Minute_PreRest_Value = Minute_Counter;
                    Set_Edit_status = 1;
                    break;
            }
        }
        ...
        switch (Set_Edit_status) {
            case (0):
                ...
                if (RB4 == 0) {
                    ...
                    switch (Select_Field_status) {
                        case (1):
                            Select_Field_status = 2;
                            break;

                        case (2):
                            Select_Field_status = 1;
                            break;
                    }
                }
                break;
        ...
        if (Minute_Counter == 100) {
            Minute_Counter = 0;
        } else if (Minute_Counter == 99) {
            Seconds_Counter = 0;
        } else if (Minute_Counter < 0) {
            Minute_Counter = 99;
        }

        if ((Minute_Counter == 0) && (Seconds_Counter == 0)) {

            if ((Minute_PreRest_Value == 0) && (Seconds_PreRest_Value == 0)) {
                Seconds_PreRest_Value = 1;
            }
            ...
            switch (Set_Edit_status) {
                ...
                case (1):
                    Seconds_Counter = Seconds_PreRest_Value;
                    Minute_Counter = Minute_PreRest_Value;
                    break;
