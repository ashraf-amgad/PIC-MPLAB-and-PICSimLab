...
int8_t Seconds_Counter = 0; // Global Counter Variable
int8_t Minute_Counter = 0; // Global Counter Variable
...
#define Clock_init_state    0
#define Clock_run_state     1
#define Clock_config_state  2
uint8_t Clock_status = Clock_init_state;


#define Edit_state    0
#define Set_state     1
uint8_t Set_Edit_status = Edit_state;
...
#define Select_Field_Minute_state 1
#define Select_Field_Hours_state  2  
