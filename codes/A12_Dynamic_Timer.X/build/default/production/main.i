...
uint8_t Clock_status = 5;




uint8_t Set_Edit_status = 9;



uint8_t LED_BLINK_STATUS = 11;



uint8_t SSD_BLINK_STATUS = 12;
# 60 "main.c"
uint8_t Select_Field_status = 14;
        ...
        switch (Set_Edit_status) {
            case (8):
                ...
                if (RB4 == 0) {
                    ...
                    switch (Select_Field_status) {
                        case (14):
                            Select_Field_status = 15;
                            break;

                        case (15):
                            Select_Field_status = 14;
                            break;
